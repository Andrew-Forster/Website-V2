class Pixel {
  ...
  class PixelCanvas extends HTMLElement {
    ...
    get colors() {
      return this.dataset.colors?.split(",") || ["rgba(13 62 176 / 0.6)", "rgb(52 83 236 / 0.6)", "rgba(26 182 255 / 0.6)"];
    }
  
    get gap() {
      const value = this.dataset.gap || 10;
      const min = 4;
      const max = 50;
    ...
    get speed() {
      const value = this.dataset.speed || 25;
      const min = 0;
      const max = 100;
